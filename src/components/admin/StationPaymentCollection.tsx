                            ...
                            <td colSpan={11} className="px-4 py-3">
                              <div className="flex flex-wrap gap-3">
                                {bk.members.map((m, i) => (
                                  <div
                                    key={i}
                                    className="flex items-center gap-3 bg-white px-3 py-2 rounded-lg border border-slate-200 shadow-sm w-full md:w-auto min-w-[200px]"
                                  >
                                    <div>
                                    ...
                                    {m.phone && (
                                      <a
                                        ...
                                        className="ml-auto text-blue-600 hover:text-blue-700 p-1.5 bg-blue-50 hover:bg-blue-100 rounded-full transition-colors"
