...
export function ActivitiesModuleView({
  ...
  const kpis = [
    {
      title: "Rafting & Water Sports",
      count: 6,
      icon: Compass,
      color: "text-blue-600 bg-blue-50 border-blue-200",
    },
    {
      title: "Paragliding Operators",
      count: 4,
      icon: Star,
    ...
    <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-black text-slate-900 tracking-tight">
              Activity Operators Subsystem
            </h1>
          </div>
          <p className="text-xs text-slate-500 font-semibold mt-0.5">
            Rafting, Paragliding, ATV, Zipline, Trekking & Safari Operators
          </p>
        </div>
        <Button
          onClick={onAddVendor}
              ...
              >
                ...
                <td className="p-3.5 font-bold text-slate-800">
                  <span className="flex items-center gap-1">
                    ...
                    {act.city || act.location || "Kullu / Solang"}
                  </span>
                </td>
                <td className="p-3.5 font-bold text-slate-800">
                  River Rafting (14 km) & Paragliding
                </td>
                <td className="p-3.5 text-slate-700 font-bold">
                  40 PAX / Batch
                </td>
                <td className="p-3.5 text-slate-700 font-bold">
                  {act.contactNumber || act.phone || "+91 98166 11111"}
                </td>
      ...
      <div className="flex justify-between items-center bg-white p-4 rounded-xl border border-slate-200 text-xs text-slate-600 font-medium">
        <span>
          ...
          {pagination.total} activity operators
        </span>
