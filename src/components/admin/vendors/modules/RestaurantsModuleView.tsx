              ...
              <tr>
                <td colSpan={5} className="p-12 text-center bg-slate-50/50">
                  <div className="space-y-2 max-w-sm mx-auto">
                    ...
                    <Button
                      onClick={onAddVendor}
                      className="mt-3 bg-[#F97316] hover:bg-[#E05E00] text-white text-xs font-bold px-4 py-2 rounded-lg cursor-pointer inline-flex items-center gap-1.5 shadow-2xs"
                    >
                ...
                >
                  <td className="py-2.5 px-4">
                    <div className="flex items-center gap-2.5">
                      <div className="w-7 h-7 rounded-md bg-orange-50 border border-orange-200 flex items-center justify-center text-[#F97316] font-bold shrink-0">
                  ...
                  <td className="py-2.5 px-4 whitespace-nowrap">
                    <span className="bg-orange-50 text-orange-800 border border-orange-200/80 font-black px-2 py-0.5 rounded-full text-[9px] uppercase tracking-wide">
                      RESTAURANT
                    </span>
                  </td>
