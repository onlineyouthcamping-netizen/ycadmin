...
export function RestaurantsModuleView({
  ...
  const kpis = [
    ...
    {
      title: "Dinner Outlets",
      count: 14,
      icon: UtensilsCrossed,
      color: "text-purple-600 bg-purple-50 border-purple-200",
    },
    {
      title: "Buffet Venues (100+ PAX)",
      count: 8,
      icon: CheckCircle2,
    ...
    <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-black text-slate-900 tracking-tight">
              Restaurant & Group Meals Subsystem
            </h1>
          </div>
          <p className="text-xs text-slate-500 font-semibold mt-0.5">
            Cafes, Dhabas, Buffet Outlets & Group Meal Venues
          </p>
        </div>
        <Button
          onClick={onAddVendor}
              ...
              <tr key={r.id} className="hover:bg-slate-50/80 transition-colors">
                ...
                <td className="p-3.5 font-bold text-slate-800">
                  <span className="flex items-center gap-1">
                    ...
                    {r.city || r.location || "Kasol / Manali"}
                  </span>
                </td>
                <td className="p-3.5 font-bold text-slate-800">
                  North Indian, Himachali & Continental
                </td>
                <td className="p-3.5">
      ...
      <div className="flex justify-between items-center bg-white p-4 rounded-xl border border-slate-200 text-xs text-slate-600 font-medium">
        <span>
          ...
          {pagination.total} restaurant outlets
        </span>
