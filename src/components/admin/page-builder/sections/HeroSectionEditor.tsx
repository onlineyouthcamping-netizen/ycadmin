...
export function HeroSectionEditor({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-1.5">
        <Label className="text-xs font-bold text-[#0B1528]">Background Image URL</Label>
        <Input
          type="url"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="space-y-1.5">
          <Label className="text-xs font-bold text-[#0B1528]">Button Text</Label>
          <Input
            type="text"
        ...
        <div className="space-y-1.5">
          <Label className="text-xs font-bold text-[#0B1528]">Button Link</Label>
          <Input
            type="text"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="space-y-1.5">
          <Label className="text-xs font-bold text-[#0B1528]">Button Style</Label>
          <Select
        ...
        <div className="space-y-1.5">
          <Label className="text-xs font-bold text-[#0B1528]">Text Alignment</Label>
          <Select
