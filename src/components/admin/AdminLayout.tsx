            ...
            const hasUserAccessToUrl = (subUrl: string) => {
              ...
              if (urlPath === '/admin/operations') {
                console.log('🔒 Permission Audit [/admin/operations]:', {
                  user: admin.email,
                  role,
                  hasOpsView: effectivePerms.includes('operations.view') || effectivePerms.includes('ops.view'),
              ...
              const urlPermissionMap: Record<string, string[]> = {
                ...
                "/admin/approvals-hub": ["bookings.verify", "tickets.approve", "accounting.view"],
                "/admin/ticket-approvals": ["tickets.approve", "tickets.view"],
                "/admin/accounting": ["accounting.view", "finance.view"],
                "/admin/travel-desk": ["tickets.view", "tickets.create", "tickets.approve"],
                "/admin/hr": ["hr.view"],
                "/admin/attendance-logs": ["hr.view", "guide.attendance"],
                "/admin/payroll": ["hr.view", "payroll.view"],
                "/admin/trips": ["trips.view"],
                "/admin/master-database": ["masterdatabase.view", "settings.view"],
                "/admin/website": ["design.view", "pagebuilder.view", "settings.view", "website.view"],
