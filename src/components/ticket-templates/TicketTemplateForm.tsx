...
export function TicketTemplateForm({
  ...
  const [formData, setFormData] = useState({
    ...
    departureDate: initialData?.departureDate
      ? initialData.departureDate.slice(0, 10)
    ...
    // Common
    journeyDate: initialData?.journeyDate
      ? initialData.journeyDate.slice(0, 10)
      : "",
    reportingTime: initialData?.reportingTime
      ? new Date(initialData.reportingTime).toISOString().slice(0, 16)
      : "",
    ...
    <form onSubmit={handleSubmit} className="space-y-4 py-2">
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-1.5 col-span-2 md:col-span-1">
          ...
          <Select
            ...
            onValueChange={(val: any) =>
              setFormData({ ...formData, transportMode: val })
            }
          >
        ...
        {formData.scope === "DEPARTURE" && (
          <div className="space-y-1.5 col-span-2">
            <label className="text-[9px] font-bold uppercase tracking-wider text-slate-400">
              Departure Date (Required for Overrides)
            </label>
            <Input
              type="date"
              required
          ...
          <>
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, flightAirline: e.target.value })
                }
                className="h-8.5 text-xs rounded-[4px] border-[#E2E8F0]"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, flightOrigin: e.target.value })
                }
                className="h-8.5 text-xs rounded-[4px] border-[#E2E8F0]"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, flightTerminal: e.target.value })
                }
                className="h-8.5 text-xs rounded-[4px] border-[#E2E8F0]"
              />
            </div>
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, baggageGuidance: e.target.value })
                }
                className="h-8.5 text-xs rounded-[4px] border-[#E2E8F0]"
              />
            </div>
          ...
          <>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, defaultClass: e.target.value })
                }
                className="h-8.5 text-xs rounded-[4px] border-[#E2E8F0]"
              />
            </div>
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, defaultCoach: e.target.value })
                }
                className="h-8.5 text-xs rounded-[4px] border-[#E2E8F0]"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, droppingPoint: e.target.value })
                }
                className="h-8.5 text-xs rounded-[4px] border-[#E2E8F0]"
              />
            </div>
        ...
        <div className="space-y-1.5 col-span-2">
          ...
          <Textarea
            ...
            onChange={(e) =>
              setFormData({ ...formData, waitlistDisclaimer: e.target.value })
            }
        ...
        <div className="flex items-center justify-between col-span-2 p-3 bg-[#F8FAFC] border border-[#E2E8F0] rounded-[4px]">
          <div className="space-y-0.5">
            ...
            <p className="text-[10px] text-slate-500">
              Active templates will be applied automatically to departures.
            </p>
          </div>
          <Switch
