...
export default function QuotationFormPage() {
        ...
        if (!isEdit) {
            ...
            if (daysData) {
                try {
                    ...
                    console.error("Failed to parse package builder itinerary days", e);
                }
            }

            if (name || phone || email || destination || initialItinerary.length > 0) {
                setFormData(prev => ({
                    ...prev,
                    ...
                    tripTitle: destination ? `${destination} Tour Package` : prev.tripTitle,
                    itinerary: initialItinerary.length > 0 ? initialItinerary : prev.itinerary,
                }));
            }
        }
    }, [isEdit]);
    ...
    const handleSave = async (status: 'Draft' | 'Published' = 'Draft') => {
        ...
        try {
            ...
            setFormData(saved);
            toast.success(status === 'Published' ? "Quotation Published Live!" : "Draft Saved Successfully");
...
${formData.expert?.designation || 'Destination Expert'}`;
    ...
    if (loading) return (
        <div className="flex flex-col items-center justify-center h-[60vh] gap-4">
            ...
            <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">Loading Proposal Details...</p>
        </div>
    );
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs font-medium text-slate-500">
                            Build client-facing interactive travel itineraries with standard & luxury pricing
                        </p>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-6 space-y-5">
                        <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
                            ...
                            <div>
                                <h3 className="font-extrabold text-sm text-[#0B1528]">Guest & Client Details</h3>
                                <p className="text-[11px] font-medium text-slate-400">Primary guest information for quotation delivery</p>
                            </div>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                <Label className="text-[11px] font-bold text-slate-500">Guest Name *</Label>
                                <Input 
                            ...
                            <div className="space-y-1.5">
                                <Label className="text-[11px] font-bold text-slate-500">WhatsApp / Contact Number *</Label>
                                <Input 
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-6 space-y-5">
                        <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
                            ...
                            <div>
                                <h3 className="font-extrabold text-sm text-[#0B1528]">Trip & Itinerary Basics</h3>
                                <p className="text-[11px] font-medium text-slate-400">Destination, duration, and group composition</p>
                            </div>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1.5 md:col-span-2">
                                <Label className="text-[11px] font-bold text-slate-500">Proposal Title *</Label>
                                <Input 
                            ...
                            <div className="space-y-1.5">
                                <Label className="text-[11px] font-bold text-slate-500">Destination / Region</Label>
                                <Input 
                            ...
                            <div className="space-y-1.5">
                                <Label className="text-[11px] font-bold text-slate-500">Duration (Nights / Days)</Label>
                                <Input 
                            ...
                            <div className="space-y-1.5">
                                <Label className="text-[11px] font-bold text-slate-500">Passenger Count (PAX)</Label>
                                <Input 
                                    type="number" 
                                    value={formData.pax} 
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-6 space-y-5">
                        <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="font-extrabold text-sm text-[#0B1528]">Package Pricing & Tiers</h3>
                                    <p className="text-[11px] font-medium text-slate-400">Configure standard and luxury package prices</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200/70 space-y-3">
                                <div className="flex items-center gap-2">
                                    ...
                                    <Label className="text-xs font-extrabold text-slate-700">Standard Tier Price</Label>
                                </div>
                                <div className="relative">
                                    ...
                                    <Input 
                                        ...
                                        onChange={e => setFormData({...formData, lowLevelPrice: parseFloat(e.target.value) || 0})} 
                            ...
                            <div className="p-4 bg-gradient-to-br from-[#0B1329] to-[#1E293B] rounded-2xl border border-slate-800 text-white space-y-3 shadow-md">
                                <div className="flex items-center gap-2">
                                    ...
                                    <Label className="text-xs font-extrabold text-amber-300">Luxury Tier Upgrade Price</Label>
                                </div>
                                <div className="relative">
                                    <span className="absolute left-3.5 top-1/2 -translate-y-1/2 font-bold text-slate-400 text-sm">₹</span>
                                    <Input 
                                        ...
                                        onChange={e => setFormData({...formData, highLevelPrice: parseFloat(e.target.value) || 0})} 
                        ...
                        <div className="pt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                <Label className="text-[11px] font-bold text-slate-500">Universal Discount (Flat Off)</Label>
                                <div className="relative">
                                    <span className="absolute left-3.5 top-1/2 -translate-y-1/2 font-bold text-slate-400 text-sm">₹</span>
                                    <Input 
                                        type="number" 
                            ...
                            <div className="space-y-1.5">
                                <Label className="text-[11px] font-bold text-slate-500">Effective Net Price</Label>
                                <div className="h-10 flex items-center px-4 bg-emerald-50 text-emerald-800 rounded-xl font-extrabold text-xs border border-emerald-200">
                                    Final Standard: ₹{((formData.lowLevelPrice || 0) - (formData.discount || 0)).toLocaleString()}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-6 space-y-4">
                        <Label className="text-xs font-extrabold text-[#0B1528]">Trip Overview & Highlights</Label>
                        <Textarea 
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-6 space-y-5">
                        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                            <h3 className="font-extrabold text-sm text-[#0B1528]">Day-by-Day Detailed Itinerary</h3>
                            <Button 
                                type="button" 
                                variant="outline" 
                                size="sm" 
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <div className="space-y-1">
                                            <Label className="text-[10px] font-bold text-slate-500 uppercase">Meals Provided</Label>
                                            <Input 
                                                value={day.meals} 
                                                onChange={e => {
                                                    const newList = [...formData.itinerary!];
                                        ...
                                        <div className="space-y-1">
                                            <Label className="text-[10px] font-bold text-slate-500 uppercase">Overnight Hotel / Stay</Label>
                                            <Input 
                                                value={day.stay} 
                                                onChange={e => {
                                                    const newList = [...formData.itinerary!];
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                <Label className="text-xs font-extrabold text-emerald-700 uppercase">Inclusions</Label>
                                <Button 
                                    type="button" 
                                    variant="ghost" 
                                    size="sm" 
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                <Label className="text-xs font-extrabold text-rose-600 uppercase">Exclusions</Label>
                                <Button 
                                    type="button" 
                                    variant="ghost" 
                                    size="sm" 
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-6 space-y-4">
                        <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                            ...
                            <h3 className="font-extrabold text-sm text-[#0B1528]">Hero Main Cover Image</h3>
                        </div>

                        <p className="text-xs text-slate-500">
                            Upload a high-resolution primary photo used in proposal cover header.
                        </p>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-6 space-y-4">
                        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                            <h3 className="font-extrabold text-sm text-[#0B1528]">Additional Hero Slider Photos</h3>
                            ...
                            <div className="grid grid-cols-3 gap-2.5 pt-2">
                                {(formData.heroImages || []).map((url, idx) => (
                                    <div key={idx} className="relative aspect-video rounded-xl overflow-hidden border border-slate-200 group/img">
                                        <img src={formatUrl(url)} className="w-full h-full object-cover" alt="Hero Slider" />
                                        <button 
                                            type="button" 
                                            onClick={() => {
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-6 space-y-4">
                        <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                            ...
                            <h3 className="font-extrabold text-sm text-[#0B1528]">Proposal Expiry Settings</h3>
                        </div>

                        <div className="space-y-3">
                            <Label className="text-xs font-bold text-slate-600">Quote Expiry Period</Label>
                            <select 
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-6 space-y-4">
                        <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                            ...
                            <h3 className="font-extrabold text-sm text-[#0B1528]">Curated By (Expert Profile)</h3>
                        </div>

                        <div className="space-y-3">
                            <div className="space-y-1">
                                <Label className="text-[11px] font-bold text-slate-500">Expert Name</Label>
                                <Input 
                            ...
                            <div className="space-y-1">
                                <Label className="text-[11px] font-bold text-slate-500">Official Designation</Label>
                                <Input 
