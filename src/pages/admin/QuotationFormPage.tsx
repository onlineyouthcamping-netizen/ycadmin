...
export default function QuotationFormPage() {
    ...
    useEffect(() => {
        if (!isEdit) {
            ...
            // Map itinerary days passed dynamically from Package Builder
            ...
            if (name || phone || email || destination || initialItinerary.length > 0) {
                setFormData(prev => ({
                    ...
                    tripTitle: destination ? `${destination} Premium Tour Package` : prev.tripTitle,
                    ...
                    <div className="modern-card p-10 space-y-10">
                            ...
                            <div className="space-y-6 p-8 bg-slate-50/50 rounded-[32px] border border-slate-100">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <Input type="number" value={formData.lowLevelPrice || 0} onChange={e => setFormData({...formData, lowLevelPrice: parseFloat(e.target.value) || 0})} className="h-14 pl-10 bg-white border-transparent focus:border-slate-200 transition-all rounded-2xl font-black text-lg" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6 p-8 bg-primary rounded-[32px] shadow-2xl shadow-orange-100">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <Input type="number" value={formData.highLevelPrice || 0} onChange={e => setFormData({...formData, highLevelPrice: parseFloat(e.target.value) || 0})} className="h-14 pl-10 bg-white/10 border-white/10 focus:border-white/20 transition-all rounded-2xl font-black text-lg text-white" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="pt-8 border-t border-slate-50 grid grid-cols-1 md:grid-cols-2 gap-10">
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    <span className="absolute left-5 top-1/2 -translate-y-1/2 font-bold text-slate-300 group-focus-within:text-slate-900 transition-colors">₹</span>
                                    <Input type="number" value={formData.discount} onChange={e => setFormData({...formData, discount: parseFloat(e.target.value) || 0})} className="h-14 pl-10 bg-slate-50/50 border-transparent focus:bg-white focus:border-slate-200 transition-all rounded-2xl font-bold" />
                                </div>
                            </div>
                            <div className="space-y-2">
