        ...
        <div className="flex items-center gap-5">
          ...
          <div className="space-y-1">
            <h1 className="text-xl font-bold text-slate-900 tracking-tight">
              {profile?.name || authAdmin?.name}
            </h1>
            <p className="text-xs text-slate-500 font-medium">
              {profile?.email || authAdmin?.email}
            </p>
            ...
            <form onSubmit={handleSaveProfile} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-[10px] text-slate-400">
                    Name is locked for security records
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-[10px] text-slate-400">
                    Email is linked to system authentication
                  </p>
                </div>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg bg-slate-50 border border-slate-200/70">
                    <div>
                      ...
                      <p className="text-[10px] text-slate-500">
                        Departure and system task updates
                      </p>
                    </div>
                    <Switch
                      checked={notifEmail}
              ...
              {!isFounder && (
                <div className="p-3.5 rounded-lg bg-amber-50 border border-amber-200 flex items-start gap-3 text-amber-900 text-xs font-medium leading-relaxed">
                  ...
                  <div>
                    <strong className="font-bold">Staff Privacy Policy:</strong>{" "}
                    System roles, access permissions, salary history, and
                    official employment documents are strictly controlled by
                    Founder Hemal Patel.
                  </div>
                </div>
              )}
            ...
            >
              ...
              <div className="pt-2 flex justify-end">
                <Button
                  ...
                  className="bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs px-6 h-9"
                >
                  {isSavingPassword && (
                    <Loader2 className="w-3.5 h-3.5 mr-2 animate-spin" />
                  )}
