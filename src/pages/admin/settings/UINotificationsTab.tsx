    ...
    <form onSubmit={handleSave} className="space-y-6 max-w-4xl">
      ...
      <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-5">
        <div className="flex items-center gap-2 border-b border-slate-100 dark:border-slate-800 pb-3">
          ...
          <h3 className="text-sm font-bold text-slate-900 dark:text-white">Appearance & Theme Customization</h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Light / Dark Mode */}
          <div className="space-y-2">
            <Label className="text-xs font-bold text-slate-700 dark:text-slate-300">Interface Theme</Label>
          ...
          {/* Theme Preset */}
          <div className="space-y-2">
            <Label className="text-xs font-bold text-slate-700 dark:text-slate-300">Color Palette Preset</Label>
          ...
          <div className="space-y-2">
            ...
            <RadioGroup value={fontSize} onValueChange={(val: any) => handleFontSizeChange(val)} className="flex items-center gap-4 pt-1">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="small" id="f-small" />
                <Label htmlFor="f-small" className="text-xs font-semibold cursor-pointer text-slate-800 dark:text-slate-300">Small (12px)</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="normal" id="f-normal" />
                <Label htmlFor="f-normal" className="text-xs font-semibold cursor-pointer text-slate-800 dark:text-slate-300">Normal (14px)</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="large" id="f-large" />
                <Label htmlFor="f-large" className="text-xs font-semibold cursor-pointer text-slate-800 dark:text-slate-300">Large (16px)</Label>
              </div>
            </RadioGroup>
          </div>
          ...
          {/* List Density */}
          <div className="space-y-2">
            <Label className="text-xs font-bold text-slate-700 dark:text-slate-300">Data Table Density</Label>
            <RadioGroup value={listView} onValueChange={(val: any) => handleTableDensityChange(val)} className="flex items-center gap-4 pt-1">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="compact" id="l-compact" />
                <Label htmlFor="l-compact" className="text-xs font-semibold cursor-pointer text-slate-800 dark:text-slate-300">Compact (High density)</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="detailed" id="l-detailed" />
                <Label htmlFor="l-detailed" className="text-xs font-semibold cursor-pointer text-slate-800 dark:text-slate-300">Detailed (Spacious)</Label>
              </div>
            </RadioGroup>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-5">
        <div className="flex items-center gap-2 border-b border-slate-100 dark:border-slate-800 pb-3">
          ...
          <h3 className="text-sm font-bold text-slate-900 dark:text-white">Notification Alerts & Email Preferences</h3>
        </div>

        <div className="space-y-4">
          <div className="flex items-center justify-between py-1">
            <div>
              <Label className="text-xs font-bold text-slate-800 dark:text-slate-200">Daily Digest Email</Label>
              <p className="text-[11px] text-slate-500 dark:text-slate-400">Summary of departures and daily bookings every morning at 8 AM</p>
            </div>
          ...
          <div className="flex items-center justify-between py-1 border-t border-slate-100 dark:border-slate-800">
            <div>
              <Label className="text-xs font-bold text-slate-800 dark:text-slate-200">Real-Time Booking Alerts</Label>
              <p className="text-[11px] text-slate-500 dark:text-slate-400">Instant notification when a new customer submits a booking</p>
            </div>
          ...
          <div className="flex items-center justify-between py-1 border-t border-slate-100 dark:border-slate-800">
            <div>
              <Label className="text-xs font-bold text-slate-800 dark:text-slate-200">Payment Confirmations</Label>
              <p className="text-[11px] text-slate-500 dark:text-slate-400">Alerts when payments or station handovers are completed</p>
            </div>
          ...
          <div className="flex items-center justify-between py-1 border-t border-slate-100 dark:border-slate-800">
            <div>
              <Label className="text-xs font-bold text-slate-800 dark:text-slate-200">Departure Reminders</Label>
              <p className="text-[11px] text-slate-500 dark:text-slate-400">Upcoming trip readiness alerts (7 days & 1 day before date)</p>
            </div>
          ...
          <div className="flex items-center justify-between py-1 border-t border-slate-100 dark:border-slate-800">
            <div>
              <Label className="text-xs font-bold text-slate-800 dark:text-slate-200">In-App Notification Sounds</Label>
              <p className="text-[11px] text-slate-500 dark:text-slate-400">Play a subtle bell sound on urgent system tasks</p>
            </div>
