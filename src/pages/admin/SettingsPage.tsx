...
import {
  Palette, Navigation, Share2, Save, Plus, Trash2, HelpCircle, Sparkles
} from "lucide-react";
    ...
    <div className="space-y-6 pb-20">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="admin-body">Configure site-wide branding, navigation, social accounts, and checkout rules.</p>
        </div>
      ...
      <Tabs defaultValue="branding" className="w-full">
        <TabsList className="grid grid-cols-2 md:grid-cols-5 w-full bg-slate-100 p-1 h-auto md:h-14 rounded-xl gap-1">
          ...
          <TabsTrigger value="booking" className="rounded-lg font-medium text-xs py-2.5 md:py-1"><HelpCircle className="w-3.5 h-3.5 mr-2" /> Booking</TabsTrigger>
          <TabsTrigger value="inquiryPopup" className="rounded-lg font-medium text-xs py-2.5 md:py-1"><Sparkles className="w-3.5 h-3.5 mr-2" /> Inquiry Popup</TabsTrigger>
        </TabsList>
