...
const INITIAL_RECORDS: MasterRecord[] = [
  // Destinations
  {
    ...
    city: "",
    region: "North India",
    cities: "Manali, Kasol, Shimla, Dharamshala, Dalhousie, Spiti",
    lastUpdated: "07 Jul 2025 11:30 AM",
    updatedBy: "Admin",
  },
  {
    id: "MR-2",
    ...
    city: "",
    region: "South India",
    cities: "Kochi, Munnar, Thekkady, Alleppey, Varkala, Trivandrum",
    lastUpdated: "07 Jul 2025 10:45 AM",
    updatedBy: "Admin",
  },
  {
    id: "MR-3",
    ...
    city: "",
    region: "West India",
    cities: "North Goa, South Goa, Panaji, Calangute, Palolem",
    lastUpdated: "07 Jul 2025 09:00 AM",
    updatedBy: "Admin",
  },
  {
    id: "MR-4",
    ...
    lastUpdated: "06 Jul 2025 04:15 PM",
    updatedBy: "Admin",
  },
  {
    id: "MR-5",
    ...
    city: "",
    region: "North India",
    cities: "Rishikesh, Mussoorie, Nainital, Dehradun, Haridwar",
    lastUpdated: "06 Jul 2025 03:20 PM",
    updatedBy: "Admin",
  },
  // Hotels
  {
    ...
    childWithBed: 800,
    childWithoutBed: 0,
    vendorName: "Blanket Hospitality Pvt Ltd",
    lastUpdated: "07 Jul 2025 09:15 AM",
    updatedBy: "Hemal",
  },
  {
    id: "MR-11",
    ...
    childWithBed: 600,
    childWithoutBed: 0,
    vendorName: "IHG Hotels Kerala",
    lastUpdated: "07 Jul 2025 08:45 AM",
    updatedBy: "Hetvi",
  },
  {
    id: "MR-12",
    ...
    childWithBed: 1500,
    childWithoutBed: 500,
    vendorName: "Leela Hotels Group",
    lastUpdated: "06 Jul 2025 05:30 PM",
    updatedBy: "Hemal",
  },
  {
    id: "MR-13",
    ...
    childWithBed: 700,
    childWithoutBed: 0,
    vendorName: "Snow Valley Hospitality",
    lastUpdated: "06 Jul 2025 02:00 PM",
    updatedBy: "Parth",
  },
  {
    id: "MR-14",
    ...
    childWithBed: 300,
    childWithoutBed: 0,
    vendorName: "Zostel Hostels",
    lastUpdated: "05 Jul 2025 11:00 AM",
    updatedBy: "Hetvi",
  },
  // Vehicles
  {
    ...
    fuelIncluded: true,
    tollIncluded: false,
    vendorName: "Kerala Cabs Pvt Ltd",
    lastUpdated: "07 Jul 2025 08:00 AM",
    updatedBy: "Parth",
  },
  {
    id: "MR-21",
    ...
    tollIncluded: false,
    vendorName: "Kerala Cabs Pvt Ltd",
    lastUpdated: "07 Jul 2025 07:45 AM",
    updatedBy: "Parth",
  },
  {
    id: "MR-22",
    category: "vehicles",
    name: "Tempo Traveller 12-Seater (AC)",
    status: "Active",
    state: "Himachal Pradesh",
    city: "Manali",
    ...
    fuelIncluded: true,
    tollIncluded: true,
    vendorName: "Himalayan Transport",
    lastUpdated: "06 Jul 2025 06:00 PM",
    updatedBy: "Hemal",
  },
  // Activities
  {
    ...
    duration: "1 hour",
    activityType: "Shared",
    lastUpdated: "07 Jul 2025 10:00 AM",
    updatedBy: "Hetvi",
  },
  {
    id: "MR-31",
    ...
    lastUpdated: "06 Jul 2025 03:00 PM",
    updatedBy: "Parth",
  },
  {
    id: "MR-32",
    ...
    duration: "Full Day",
    activityType: "Private",
    lastUpdated: "07 Jul 2025 09:30 AM",
    updatedBy: "Hemal",
  },
  {
    id: "MR-33",
    ...
    duration: "4 hours",
    activityType: "Shared",
    lastUpdated: "06 Jul 2025 01:00 PM",
    updatedBy: "Hetvi",
  },
  // Transfers
  {
    ...
    transferRate: 3500,
    perKmRate: 14,
    lastUpdated: "07 Jul 2025 07:30 AM",
    updatedBy: "Parth",
  },
  {
    id: "MR-41",
    ...
    transferRate: 3000,
    perKmRate: 14,
    lastUpdated: "07 Jul 2025 07:20 AM",
    updatedBy: "Parth",
  },
  {
    id: "MR-42",
    category: "transfers",
    name: "Thekkady → Alleppey",
    status: "Active",
    state: "Kerala",
    city: "Thekkady",
    fromCity: "Thekkady",
    ...
    transferRate: 3800,
    perKmRate: 14,
    lastUpdated: "07 Jul 2025 07:10 AM",
    updatedBy: "Parth",
  },
  {
    id: "MR-43",
    ...
    transferRate: 2500,
    perKmRate: 18,
    lastUpdated: "06 Jul 2025 05:00 PM",
    updatedBy: "Hemal",
  },
  // Meals
  {
    ...
    mealType: "Breakfast",
    mealCost: 350,
    lastUpdated: "07 Jul 2025 06:00 AM",
    updatedBy: "Admin",
  },
  {
    id: "MR-51",
  ...
  },
  {
    id: "MR-61",
    category: "vendors",
    name: "Blanket Hospitality Pvt Ltd",
    status: "Active",
    state: "Kerala",
    city: "Munnar",
    vendorType: "Hotel",
    ...
    lastUpdated: "06 Jul 2025 04:00 PM",
    updatedBy: "Admin",
  },
  {
    id: "MR-62",
    category: "vendors",
    name: "Himalayan Transport",
    status: "Active",
    state: "Himachal Pradesh",
    city: "Manali",
    vendorType: "Transport",
    ...
    lastUpdated: "06 Jul 2025 03:30 PM",
    updatedBy: "Admin",
  },
];
...
const blankRecord = (cat: CategoryId): Partial<MasterRecord> => ({
  ...
  ...(cat === "vehicles"
    ...
    : {}),
  ...(cat === "activities"
    ? { adultRate: 0, childRate: 0, duration: "", activityType: "Shared" }
    : {}),
  ...(cat === "transfers"
    ? {
        fromCity: "",
  ...
  ...(cat === "vendors"
    ? { vendorType: "Hotel", contactPerson: "", contactPhone: "" }
    : {}),
});
...
export default function MasterDatabasePage() {
  ...
  const inputCls =
    "h-9 rounded-lg border-slate-300 text-xs font-semibold text-[#17233C] placeholder:text-slate-400 w-full px-3 focus-visible:ring-1 focus-visible:ring-[#F97316]";
  const selectCls =
    "h-9 rounded-lg border border-slate-300 text-xs font-semibold text-[#17233C] w-full px-3 bg-white focus:outline-none focus:ring-1 focus:ring-[#F97316] cursor-pointer";
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-200/80 pb-5">
        <div className="space-y-1">
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-medium leading-relaxed">
            Manage destinations, hotels, vehicles, activities, transfers, meals,
            and vendors.
          </p>
        </div>
          ...
          <DropdownMenu>
            ...
            >
              {CATEGORY_META.map((cat) => (
                ...
                >
                  <cat.icon className="w-4 h-4 mr-2 text-[#F97316]" /> Add{" "}
                  {cat.label}
                </DropdownMenuItem>
              ))}
            </DropdownMenuContent>
          ...
          return (
            <Card
              ...
              className={cn(
                ...
                isActive
                  ? "border-[#F97316] ring-2 ring-[#F97316]/20 bg-orange-50/30"
                  ...
                  <div className="flex items-center justify-between pt-1 border-t border-slate-100">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() => setDeleteConfirm(r.id)}
                        className="h-7 px-2.5 text-xs font-semibold text-rose-600 border-rose-200 hover:bg-rose-50 rounded-lg"
                      >
                        <Trash2 className="w-3.5 h-3.5" />
                      </Button>
                    </div>
          ...
          <div className="space-y-4 pt-2">
            ...
            <DialogFooter className="pt-4 border-t border-slate-100 flex items-center justify-end gap-2">
              ...
              <Button
                type="button"
                onClick={handleSave}
                className="h-8 bg-[#F97316] hover:bg-[#EA580C] text-white text-xs font-semibold rounded-lg shadow-xs flex items-center gap-1"
              >
          ...
          {viewRecord && (
            <div className="space-y-3 pt-2 text-xs">
              ...
              <div className="flex justify-between py-1.5 border-b">
                ...
                <span
                  className={`font-bold uppercase ${viewRecord.status === "Active" ? "text-emerald-600" : "text-rose-600"}`}
                >
                  {viewRecord.status}
                </span>
              </div>
        ...
        <DialogContent className="max-w-sm p-6 bg-white rounded-2xl border border-slate-200 shadow-xl">
          ...
          <DialogFooter className="pt-4 border-t border-slate-100 flex items-center justify-end gap-2">
            ...
            <Button
              ...
              className="h-8 bg-rose-600 hover:bg-rose-700 text-white text-xs font-semibold rounded-lg shadow-xs"
            >
              Delete Record
            </Button>
          </DialogFooter>
