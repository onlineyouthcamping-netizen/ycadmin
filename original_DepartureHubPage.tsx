...
import {
  ...
  AlertTriangle, Clock, MapPin, Star, Link2, Paperclip, Image,
...
export default function DepartureHubPage() {
  ...
  const ctaLabel: Record<string,string> = {
    ...
    itinerary:"+ Add Day", hotels:"+ Add Hotel", transport:"+ Add Vehicle",
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        ...
        {activeTab === "transport" && (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-base font-black text-slate-800">Transport</h2>
                <p className="text-[11px] text-slate-500 mt-0.5">Manage all travel arrangements for this departure</p>
              </div>
              <div className="flex gap-2">
                <button onClick={() => toast.info("View Timeline")} className="text-[11px] font-bold border border-slate-200 rounded-[4px] px-3.5 py-1.5 bg-white hover:bg-slate-50 text-slate-700 flex items-center gap-1.5 shadow-xs">
                  <Sliders className="w-3.5 h-3.5 text-slate-400" /> View as Timeline
            ...
            <div className="bg-white border border-[#E2E8F0] rounded-[6px] p-3.5 shadow-xs flex flex-wrap gap-2.5 items-center">
              ...
              <button className="h-8 text-[11px] font-bold border border-slate-200 rounded-[4px] px-3.5 bg-white hover:bg-slate-50 text-slate-755 flex items-center gap-1.5 ml-auto shadow-3xs">
                <Sliders className="w-3.5 h-3.5 text-slate-455" /> More Filters
              </button>
            </div>
                ...
                <table className="w-full text-left text-xs border-collapse">
                  <thead className="bg-slate-50 border-b border-[#E2E8F0]">
                    <tr className="text-[9.5px] font-bold text-slate-455 uppercase tracking-wider">
                      ...
                      <th className="p-3 border-r border-slate-100 w-36">TYPE</th>
                      <th className="p-3 border-r border-slate-100 w-44">VEHICLE / DETAILS</th>
                      <th className="p-3 border-r border-slate-100 w-[15%]">VENDOR</th>
                      <th className="p-3 border-r border-slate-100 w-[15%]">PICKUP</th>
                      <th className="p-3 border-r border-slate-100 w-[15%]">DROPOFF</th>
                      <th className="p-3 border-r border-slate-100 w-24">DATES</th>
                    ...
                    {computedTransport.map((row, idx) => (
                      <tr key={idx} className="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="p-3 border-r border-slate-100">
                          ...
                          <p className="text-[10px] text-slate-450 font-semibold mt-0.5">({row.cap})</p>
                        </td>
                        <td className="p-3 border-r border-slate-100">
                          <p className="font-bold text-slate-855 font-mono">{row.plate}</p>
                          <p className="text-[10px] text-slate-400 font-semibold mt-0.5">{row.model}</p>
                        </td>
                        <td className="p-3 border-r border-slate-100">
                          <p className="font-bold text-slate-800">{row.vendor}</p>
                          <p className="text-[9.5px] text-slate-450 font-semibold mt-0.5">{row.phone}</p>
                        </td>
                        <td className="p-3 border-r border-slate-100">
                          <p className="font-bold text-slate-800">{row.from}</p>
                          <p className="text-[9.5px] text-slate-455 font-semibold mt-0.5">{row.fromTime}</p>
                        </td>
                        <td className="p-3 border-r border-slate-100">
                          <p className="font-bold text-slate-800">{row.to}</p>
                          <p className="text-[9.5px] text-slate-455 font-semibold mt-0.5">{row.toTime}</p>
                        </td>
                        <td className="p-3 border-r border-slate-100">
                        ...
                        <td className="p-3 border-r border-slate-100 text-right font-bold text-red-650">{row.due}</td>
                        <td className="p-3 border-r border-slate-100">
                ...
                <table className="w-full text-left text-xs border-collapse">
                  <thead className="bg-slate-50 border-b border-[#E2E8F0]">
                    <tr className="text-[9.5px] font-bold text-slate-455 uppercase tracking-wider">
                      ...
                      <th className="p-3 border-r border-slate-100 w-[20%]">ROUTE</th>
                      <th className="p-3 border-r border-slate-100 w-[12%]">DEPARTURE</th>
                      <th className="p-3 border-r border-slate-100 w-[12%]">ARRIVAL</th>
                      <th className="p-3 border-r border-slate-100 w-28">DATE</th>
                      <th className="p-3 border-r border-slate-100 w-36">PASSENGERS</th>
                      <th className="p-3 border-r border-slate-100">STATUS</th>
                      <th className="p-3 text-center w-24">ACTION</th>
                    </tr>
                  </thead>
            ...
            <div className="space-y-2.5">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => toast.info("Add other transport")} className="text-[10.5px] font-extrabold text-slate-750 bg-white hover:bg-slate-50 border border-slate-200 px-3 py-1 rounded-[4px] shadow-3xs flex items-center gap-1">
                  <Plus className="w-3 h-3" /> Add Other Transport
                </button>
              </div>
              <div className="bg-white border border-[#E2E8F0] rounded-[6px] p-8 text-center flex flex-col items-center justify-center gap-2.5 shadow-3xs">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-800">No other transport bookings</p>
